...
//    {kCTParagraphStyleSpecifierMinimumLineSpacing, sizeof(CGFloat), &lineSpacing}
    ...
    textAttachment3.bounds = CGRectMake(0, 0, 60, 60);
    //
    NSMutableAttributedString* attributeString = [[NSMutableAttributedString alloc] initWithString:@"鹅鹅鹅，曲项向天歌，白毛浮绿水，红掌拨清波。锄禾日当午，汗滴禾下土，谁知盘中餐，粒粒皆辛苦。青青子衿，悠悠我心，譬如朝露，去日苦多，慨当以慷，忧思难忘" attributes:@{NSParagraphStyleAttributeName:paragraph,NSFontAttributeName:[UIFont systemFontOfSize:20.0f]}];
